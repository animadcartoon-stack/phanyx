...
export async function enviarEmailAssinaturaContratoInstitucional({
  instituicaoId,
  email,
  nome,
  instituicao,
                ...
                <tr>
                  <td style="padding:34px 32px 24px 32px;background:linear-gradient(135deg,#2563eb 0%,#0f172a 100%);text-align:center;">
                    ...
                    <p style="margin:12px 0 0 0;color:#dbeafe;font-size:16px;line-height:1.7;">
                      A instituição <strong>${instituicao}</strong> enviou um documento para sua assinatura.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:32px;">
                    ...
                    <p style="margin:0 0 24px 0;color:#cbd5e1;font-size:15px;line-height:1.7;">
                      Clique no botão abaixo para acessar o documento e realizar a assinatura.
                    </p>

                    <div style="margin:28px 0;">
                      <a
                        href="${linkAssinatura}"
                        style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;font-weight:bold;padding:14px 22px;border-radius:14px;font-size:15px;"
                      >
                    ...
                    <p style="margin:28px 0 0 0;color:#94a3b8;font-size:13px;line-height:1.7;">
                      Se você não reconhece esta solicitação, entre em contato com a instituição.
                    </p>
                  </td>
                </tr>
...
export async function enviarEmailPrimeiroAcessoInstitucional({
  instituicaoId,
  email,
  nome,
  senha,
