                ...
                <div className="phanyx-table-tools-panel w-full rounded-2xl border border-slate-300 bg-white p-3 text-slate-900 shadow-sm dark:border-slate-700 dark:bg-slate-950 dark:text-white">
                  {!editor.isActive("table") ? (
                      ...
                      <div className="flex flex-wrap items-end gap-3">
                        <label className="text-xs font-semibold">
                          ...
                          <input
                            ...
                            className="w-24 rounded-lg border border-slate-300 bg-white px-2 py-2 text-sm text-slate-900 outline-none focus:border-blue-500 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
                          />
                        </label>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="grid grid-cols-1 gap-3 border-t border-slate-200 pt-3 md:grid-cols-2 xl:grid-cols-4 dark:border-slate-800">
                        <label className="text-xs font-semibold">
                          <span className="mb-1 block">
                            {tToolbar(
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="rounded-lg border border-slate-300 px-2 py-2 text-[11px] font-bold dark:border-slate-700"
                            >
                              {tToolbar(
                                "table.clearBackground"
                              )}
                            </button>
                          </div>
                        </label>
                        ...
                        <label className="text-xs font-semibold">
                          ...
                          <select
                            ...
                            className="w-full rounded-lg border border-slate-300 bg-white px-2 py-2 text-xs text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
                          >
                            <option value="solid">
                              {tToolbar(
                                "table.borderSolid"
                        ...
                        <div className="rounded-xl border border-slate-200 p-3 md:col-span-2 xl:col-span-4 dark:border-slate-800">
                          <div className="mb-2">
                            {linhaTabelaSelecionada ? (
                              <div className="inline-flex rounded-lg border border-blue-300 bg-blue-50 px-3 py-2 text-xs font-black text-blue-800 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-200">
                            ...
                            <label className="text-xs font-semibold">
                              ...
                              <div className="flex items-center gap-2">
                                <input
                                  ...
                                  className="w-24 rounded-lg border border-slate-300 bg-white px-2 py-2 text-xs text-slate-900 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
                                />
  ...
  return (
    ...
    >
      ...
      <style jsx global>{`
        ...
        .editor-template-phanyx .tableWrapper {
          overflow-x: auto;
          padding: 2px 0 6px;
        }

        .editor-template-phanyx td,
        .editor-template-phanyx th {
          position: relative;
          box-sizing: border-box;
          color: #0f172a;
        }

        .editor-template-phanyx .selectedCell::after {
          position: absolute;
          inset: 0;
          z-index: 2;
          pointer-events: none;
        ...
        .editor-template-phanyx .column-resize-handle {
          position: absolute;
          top: 0;
          right: -3px;
          bottom: 0;
