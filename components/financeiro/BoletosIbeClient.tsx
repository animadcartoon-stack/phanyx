                                ...
                                <div className="mt-5 space-y-4">
                                    {modulos.map(
                                        (modulo, indice) => {
                                            ...
                                            const chaveModulo = String(
                                                modulo.id ??
                                                `modulo-${indice}`
                                            );

                                            const moduloAberto =
                                                modulosAbertos[chaveModulo] ??
                                                indice === 0;

                                            const quantidadeSelecionadaModulo =
                                                idsModulo.filter((id) =>
                                                    disciplinasSelecionadas.includes(id)
                                                ).length;

                                            const idPainelModulo =
                                                `disciplinas-modulo-${indice}`;
                                                ...
                                                >
                                                    <div className="flex flex-col gap-3 bg-slate-100 px-4 py-3 dark:bg-slate-800/80 sm:flex-row sm:items-center sm:justify-between">
                                                        <button
                                                            ...
                                                            aria-controls={idPainelModulo}
                                                            className="flex min-w-0 flex-1 items-center gap-3 rounded-lg text-left outline-none transition hover:opacity-80 focus-visible:ring-2 focus-visible:ring-slate-500"
                                                        >
                                                            <span
                                                                aria-hidden="true"
                                                                className={[
                                                                    "inline-flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-slate-300 bg-white text-xs font-black text-slate-700 transition-transform duration-200 dark:border-slate-600 dark:bg-slate-900 dark:text-white",
                                                                    moduloAberto
                                                                        ? "rotate-90"
                                                                        : "rotate-0",
                                                                ].join(" ")}
                                                            ...
                                                            <span className="min-w-0">
                                                                ...
                                                                <span className="mt-0.5 block text-xs text-slate-500 dark:text-slate-400">
                                                                    ...
                                                                    {disciplinas.length === 1
                                                                        ...
                                                                        : "s"}
                                                                    {" · "}
                                                                    {quantidadeSelecionadaModulo}{" "}
                                                                    selecionada
                                                                    {quantidadeSelecionadaModulo === 1
                                                                        ? ""
                                                                        : "s"}
                                                                </span>
                                                            </span>
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-fit shrink-0 rounded-lg border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-600 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
                                                        >
                                                            {moduloCompleto
                                                                ? "Desmarcar módulo"
                                                                : "Selecionar módulo"}
