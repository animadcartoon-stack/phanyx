...
-- CreateTable
CREATE TABLE "LeadMovimentacaoFunil" (
    "id" SERIAL NOT NULL,
    "instituicaoId" INTEGER NOT NULL,
    ...
    "etapaNovaId" INTEGER,
    "movimentadoPorId" INTEGER,
    "origem" "OrigemMovimentacaoFunilComercial" NOT NULL DEFAULT 'MANUAL',
    "motivo" TEXT,
    "tempoEtapaAnteriorMinutos" INTEGER,
    "dados" JSONB,
    "funilNomeSnapshot" TEXT,
    "etapaAnteriorNomeSnapshot" TEXT,
    "etapaNovaNomeSnapshot" TEXT,
    "movimentadoPorNomeSnapshot" TEXT,
    "criadoEm" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "LeadMovimentacaoFunil_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "LeadTransferencia" (
    "id" SERIAL NOT NULL,
    "instituicaoId" INTEGER NOT NULL,
    "leadId" INTEGER NOT NULL,
    "responsavelAnteriorId" INTEGER,
    "responsavelNovoId" INTEGER,
    "equipeAnteriorId" INTEGER,
    "equipeNovaId" INTEGER,
    "realizadoPorId" INTEGER,
    "origem" "OrigemTransferenciaLead" NOT NULL DEFAULT 'MANUAL',
    "motivo" TEXT,
    "responsavelAnteriorNomeSnapshot" TEXT,
    "responsavelNovoNomeSnapshot" TEXT,
    "equipeAnteriorNomeSnapshot" TEXT,
    "equipeNovaNomeSnapshot" TEXT,
    "realizadoPorNomeSnapshot" TEXT,
    "criadoEm" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "LeadTransferencia_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "TarefaComercial" (
    ...
    "instituicaoId" INTEGER NOT NULL,
    "leadId" INTEGER NOT NULL,
    "responsavelFuncionarioId" INTEGER,
    "criadoPorId" INTEGER,
    "atualizadoPorId" INTEGER,
    "concluidaPorId" INTEGER,
    "canceladaPorId" INTEGER,
    "tipo" "TipoTarefaComercial" NOT NULL,
    "status" "StatusTarefaComercial" NOT NULL DEFAULT 'PENDENTE',
    "prioridade" "PrioridadeTarefaComercial" NOT NULL DEFAULT 'MEDIA',
    "titulo" TEXT NOT NULL,
    "descricao" TEXT,
    "resultado" TEXT,
    "motivoCancelamento" TEXT,
    "proximaAcao" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_instituicaoId_idx" ON "LeadMovimentacaoFunil"("instituicaoId");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_leadId_idx" ON "LeadMovimentacaoFunil"("leadId");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_funilId_idx" ON "LeadMovimentacaoFunil"("funilId");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_etapaAnteriorId_idx" ON "LeadMovimentacaoFunil"("etapaAnteriorId");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_etapaNovaId_idx" ON "LeadMovimentacaoFunil"("etapaNovaId");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_movimentadoPorId_idx" ON "LeadMovimentacaoFunil"("movimentadoPorId");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_origem_idx" ON "LeadMovimentacaoFunil"("origem");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_criadoEm_idx" ON "LeadMovimentacaoFunil"("criadoEm");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_instituicaoId_leadId_criadoEm_idx" ON "LeadMovimentacaoFunil"("instituicaoId", "leadId", "criadoEm");

-- CreateIndex
CREATE INDEX "LeadMovimentacaoFunil_instituicaoId_etapaNovaId_criadoEm_idx" ON "LeadMovimentacaoFunil"("instituicaoId", "etapaNovaId", "criadoEm");

-- CreateIndex
CREATE INDEX "LeadTransferencia_instituicaoId_idx" ON "LeadTransferencia"("instituicaoId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_leadId_idx" ON "LeadTransferencia"("leadId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_responsavelAnteriorId_idx" ON "LeadTransferencia"("responsavelAnteriorId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_responsavelNovoId_idx" ON "LeadTransferencia"("responsavelNovoId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_equipeAnteriorId_idx" ON "LeadTransferencia"("equipeAnteriorId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_equipeNovaId_idx" ON "LeadTransferencia"("equipeNovaId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_realizadoPorId_idx" ON "LeadTransferencia"("realizadoPorId");

-- CreateIndex
CREATE INDEX "LeadTransferencia_origem_idx" ON "LeadTransferencia"("origem");

-- CreateIndex
CREATE INDEX "LeadTransferencia_criadoEm_idx" ON "LeadTransferencia"("criadoEm");

-- CreateIndex
CREATE INDEX "LeadTransferencia_instituicaoId_leadId_criadoEm_idx" ON "LeadTransferencia"("instituicaoId", "leadId", "criadoEm");

-- CreateIndex
CREATE INDEX "LeadTransferencia_instituicaoId_responsavelNovoId_criadoEm_idx" ON "LeadTransferencia"("instituicaoId", "responsavelNovoId", "criadoEm");

-- CreateIndex
CREATE INDEX "TarefaComercial_instituicaoId_idx" ON "TarefaComercial"("instituicaoId");

-- CreateIndex
CREATE INDEX "TarefaComercial_leadId_idx" ON "TarefaComercial"("leadId");

-- CreateIndex
CREATE INDEX "TarefaComercial_responsavelFuncionarioId_idx" ON "TarefaComercial"("responsavelFuncionarioId");

-- CreateIndex
CREATE INDEX "TarefaComercial_criadoPorId_idx" ON "TarefaComercial"("criadoPorId");

-- CreateIndex
CREATE INDEX "TarefaComercial_atualizadoPorId_idx" ON "TarefaComercial"("atualizadoPorId");

-- CreateIndex
CREATE INDEX "TarefaComercial_concluidaPorId_idx" ON "TarefaComercial"("concluidaPorId");

-- CreateIndex
CREATE INDEX "TarefaComercial_canceladaPorId_idx" ON "TarefaComercial"("canceladaPorId");

-- CreateIndex
CREATE INDEX "TarefaComercial_tipo_idx" ON "TarefaComercial"("tipo");

-- CreateIndex
CREATE INDEX "TarefaComercial_status_idx" ON "TarefaComercial"("status");

-- CreateIndex
CREATE INDEX "TarefaComercial_prioridade_idx" ON "TarefaComercial"("prioridade");

-- CreateIndex
CREATE INDEX "TarefaComercial_agendadaPara_idx" ON "TarefaComercial"("agendadaPara");

-- CreateIndex
CREATE INDEX "TarefaComercial_prazoEm_idx" ON "TarefaComercial"("prazoEm");

-- CreateIndex
CREATE INDEX "TarefaComercial_lembreteEm_idx" ON "TarefaComercial"("lembreteEm");

-- CreateIndex
CREATE INDEX "TarefaComercial_instituicaoId_status_agendadaPara_idx" ON "TarefaComercial"("instituicaoId", "status", "agendadaPara");

-- CreateIndex
CREATE INDEX "TarefaComercial_instituicaoId_responsavelFuncionarioId_stat_idx" ON "TarefaComercial"("instituicaoId", "responsavelFuncionarioId", "status", "agendadaPara");

-- CreateIndex
CREATE INDEX "TarefaComercial_leadId_status_agendadaPara_idx" ON "TarefaComercial"("leadId", "status", "agendadaPara");
...
-- AddForeignKey
ALTER TABLE "LeadMovimentacaoFunil" ADD CONSTRAINT "LeadMovimentacaoFunil_instituicaoId_fkey" FOREIGN KEY ("instituicaoId") REFERENCES "Instituicao"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadMovimentacaoFunil" ADD CONSTRAINT "LeadMovimentacaoFunil_leadId_fkey" FOREIGN KEY ("leadId") REFERENCES "Lead"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadMovimentacaoFunil" ADD CONSTRAINT "LeadMovimentacaoFunil_funilId_fkey" FOREIGN KEY ("funilId") REFERENCES "FunilComercial"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadMovimentacaoFunil" ADD CONSTRAINT "LeadMovimentacaoFunil_etapaAnteriorId_fkey" FOREIGN KEY ("etapaAnteriorId") REFERENCES "EtapaFunilComercial"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadMovimentacaoFunil" ADD CONSTRAINT "LeadMovimentacaoFunil_etapaNovaId_fkey" FOREIGN KEY ("etapaNovaId") REFERENCES "EtapaFunilComercial"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadMovimentacaoFunil" ADD CONSTRAINT "LeadMovimentacaoFunil_movimentadoPorId_fkey" FOREIGN KEY ("movimentadoPorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_instituicaoId_fkey" FOREIGN KEY ("instituicaoId") REFERENCES "Instituicao"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_leadId_fkey" FOREIGN KEY ("leadId") REFERENCES "Lead"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_responsavelAnteriorId_fkey" FOREIGN KEY ("responsavelAnteriorId") REFERENCES "Funcionario"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_responsavelNovoId_fkey" FOREIGN KEY ("responsavelNovoId") REFERENCES "Funcionario"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_equipeAnteriorId_fkey" FOREIGN KEY ("equipeAnteriorId") REFERENCES "EquipeComercial"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_equipeNovaId_fkey" FOREIGN KEY ("equipeNovaId") REFERENCES "EquipeComercial"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "LeadTransferencia" ADD CONSTRAINT "LeadTransferencia_realizadoPorId_fkey" FOREIGN KEY ("realizadoPorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_instituicaoId_fkey" FOREIGN KEY ("instituicaoId") REFERENCES "Instituicao"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_leadId_fkey" FOREIGN KEY ("leadId") REFERENCES "Lead"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_responsavelFuncionarioId_fkey" FOREIGN KEY ("responsavelFuncionarioId") REFERENCES "Funcionario"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_criadoPorId_fkey" FOREIGN KEY ("criadoPorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_atualizadoPorId_fkey" FOREIGN KEY ("atualizadoPorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_concluidaPorId_fkey" FOREIGN KEY ("concluidaPorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "TarefaComercial" ADD CONSTRAINT "TarefaComercial_canceladaPorId_fkey" FOREIGN KEY ("canceladaPorId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
