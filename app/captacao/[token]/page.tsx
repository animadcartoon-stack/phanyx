...
export default function FormularioPublicoCaptacaoPage() {
  ...
  function renderizarCampo(
    ...
    const classeInput =
      `w-full rounded-xl border px-3.5 py-3 text-base text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 ${
        erroCampo
