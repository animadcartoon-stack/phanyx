...
function LoginContent() {
  ...
  const cardNormal = "border-slate-200 bg-white";
          ...
          <div className="space-y-4 lg:hidden">
            <button
              ...
              className={`block w-full rounded-3xl border p-5 text-left shadow-sm transition ${
                portalSelecionado === "aluno" ? cardSelecionado : cardNormal
              }`}
            >
            ...
            <button
              ...
              className={`block w-full rounded-3xl border p-5 text-left shadow-sm transition ${
                portalSelecionado === "professor" ? cardSelecionado : cardNormal
              }`}
            >
              <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`block w-full rounded-3xl border p-5 text-left shadow-sm transition ${
                portalSelecionado === "admin" ? cardSelecionado : cardNormal
              }`}
            >
              <div className="flex items-center gap-4">
