                  ...
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <h3 className="pdoc-label font-semibold">
                          {tVisual(
                            "academicContract.title"
                          )}
                        </h3>
                      </div>

                      <p className="pdoc-muted mt-2 max-w-4xl text-sm leading-relaxed">
                        {tVisual(
                          "academicContract.description"
                        )}
                      </p>
                    </div>

                    <span className="pdoc-badge-green inline-flex shrink-0 rounded-full px-3 py-1.5 text-xs font-bold">
                      {tVisual(
                        "academicContract.badge"
                      )}
                    </span>
                  </div>

                  <div className="pdoc-card mt-3 rounded-xl border p-3">
                    <p className="pdoc-muted text-xs leading-relaxed">
                      {tVisual(
                        "academicContract.help"
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="pdoc-soft rounded-2xl border p-4">
                  <div className="mb-3 flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p className="pdoc-muted text-xs">
                        {tVisual(
                          "visualFields.description"
                        )}
                      </p>
                    </div>
                    ...
                    >
                      {tVisual(
                        "visualFields.addDirectorSignature"
                      )}
                    </button>
                  </div>
                    ...
                    <div className="pdoc-soft mx-auto w-full max-w-[520px] rounded-2xl border p-5">
                      ...
                      <div className="relative h-[150px] rounded-xl border bg-white">
                        ...
                        <div className="absolute left-10 top-[100px] text-xs text-slate-600">
                          {tVisual(
                            "visualFields.directorNamePlaceholder"
                          )}
                        </div>
                          ...
                          >
                            {configInstituicao?.certificadoAssinaturaUrl ? (
                              <img
                                ...
                                alt={tVisual(
                                  "visualFields.directorSignatureAlt"
                                )}
                                className="pointer-events-none h-full w-full object-contain contrast-200 brightness-75 saturate-0"
                                draggable={false}
                              />
                            ) : (
                              <div className="flex h-full w-full items-center justify-center rounded border border-dashed border-blue-400 bg-blue-50 text-center text-[9px] font-semibold text-blue-700">
                                {tVisual(
                                  "visualFields.signaturePlaceholder"
                                )}
                              </div>
                            )}
                      ...
                      <p className="pdoc-muted mt-3 text-xs">
                        {tVisual(
                          "visualFields.positionHelp"
                        )}
                      </p>
                    </div>
                  </div>
