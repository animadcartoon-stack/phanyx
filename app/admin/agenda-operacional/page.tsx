...
<div className="mt-4 rounded-2xl border border-slate-300 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
  ...
  <p className="text-sm text-slate-600 dark:text-slate-400">
    Personalize a visualização da Agenda Operacional. Configure independentemente as colunas exibidas na tela, no PDF e na exportação para Excel. Essas preferências ficam salvas para seu usuário.
  </p>
</div>
...
>
  ...
  className="agenda-operacional-linha cursor-pointer border-b border-slate-200 text-slate-900 transition dark:border-slate-800 dark:text-slate-100"
>
