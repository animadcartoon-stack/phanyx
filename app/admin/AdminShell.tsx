...
export default function AdminShell({
  ...
  const [usuario, setUsuario] = useState<UsuarioLogado | null>(usuarioInicial);
  const [permissoes, setPermissoes] = useState<string[]>(permissoesIniciais);
  ...
  useEffect(() => {
    function rolarSidebarAteAlvo(seletor: string) {
      ...
      window.setTimeout(() => {
        ...
        window.setTimeout(() => {
          ...
          window.dispatchEvent(new CustomEvent("phanyx:reposicionar-tour"));
        }, 450);
      }, 100);
    }
    ...
    function abrirMenuConfiguracoes() {
      ...
      rolarSidebarAteAlvo('[data-tour="menu-configuracoes"]');
    }

    function abrirMenuAcademico(evento: Event) {
      setMenuAberto("academico");

      const detalhe = (evento as CustomEvent<{ seletor?: string }>).detail;

      rolarSidebarAteAlvo(detalhe?.seletor || '[data-tour="menu-alunos"]');
    }
  ...
  async function carregarNotificacoes() {
    try {
      ...
      setNotificacoesAdmin(
        Array.isArray(data.notificacoes) ? data.notificacoes : [],
      );
  ...
  const podeGerenciarPolos =
    usuarioAdmin && usuario?.podeGerenciarPolos === true;
  ...
  const podeGerenciarRematriculasSemestrais =
    roleUsuario === "ADMIN" || roleUsuario === "SUPER_ADMIN";
  ...
  const podeVerVisaoGeralComercial = podeAcessar(
    "comercial.ver",
  ...
  const podeVerEquipesComerciais = podeAcessar("comercial.equipes.ver");

  const podeVerMetasComerciais = podeAcessar("comercial.metas.ver");

  const podeVerRelatoriosComerciais = podeAcessar("comercial.relatorios.ver");

  const podeGerenciarConfiguracoesComerciais = podeAcessar(
    "comercial.configuracoes.gerenciar",
  );

  const podeVerAtividadesExternas = podeAcessar(
  ...
  const podeVerMobilidade =
    ...
    permissoes.some((chave) => chave.startsWith("mobilidade."));
  ...
  const podeGerenciarEmailInstitucional = podeAcessar(
    "integracoes.email.gerenciar",
  );

  const podeGerenciarWhatsappInstitucional = podeAcessar(
  ...
  const podeVerComercialPhanyx =
    !carregandoUsuario &&
    (usuario?.isMasterAdmin === true || usuario?.role === "SUPER_ADMIN");

  useEffect(() => {
    if (!pathname?.startsWith("/admin/leads")) return;

    setMenuAberto(podeVerComercialPhanyx ? "comercial-phanyx" : "comercial");
              ...
              <nav className="flex flex-col space-y-2">
                ...
                {podeVerComercialPhanyx && (
                  <div className="border-t pt-2 mt-2">
                    <button
                      type="button"
                      onClick={() => toggleMenu("comercial-phanyx")}
                      className={buttonClass}
                    >
                      <span className={sectionTitleClass}>
                      ...
                      <div className="ml-3 mt-2 flex flex-col space-y-1">
                        {podeVerVisaoGeralComercial && (
                          <Link
                            ...
                            className={getLinkClass("/admin/comercial")}
                          >
                            📊 {tNav("overview")}
                          </Link>
                        )}
                        ...
                        {podeVerFunisComerciais && (
                          <Link
                            ...
                            className={getLinkClass("/admin/comercial/funis")}
                          >
                            🧭 {tNav("salesFunnels")}
                          </Link>
                        )}
                        ...
                        {podeVerEquipesComerciais && (
                          <Link
                            ...
                            className={getLinkClass("/admin/comercial/equipes")}
                          >
                            👥 {tNav("salesTeams")}
                          </Link>
                        )}
                        ...
                        {podeVerMetasComerciais && (
                          <Link
                            ...
                            className={getLinkClass("/admin/comercial/metas")}
                          >
                            📈 {tNav("salesTargets")}
                          </Link>
                        )}
                  ...
                  {menuAberto === "academico" && (
                    <div className="ml-3 mt-2 flex flex-col space-y-1">
                      ...
                      <Link
                        ...
                        className={getLinkClass("/admin/student-success")}
                      >
                        🧠 {tNav("studentSuccess")}
                      </Link>
                ...
                {podeVerMobilidade && (
                  <div className="mt-2 border-t pt-2">
                    ...
                    >
                      ...
                      <span>{menuAberto === "mobilidade" ? "▾" : "▸"}</span>
                    </button>
                ...
                {podeVerBiblioteca && (
                  <div className="mt-2 border-t pt-2">
                    ...
                    >
                      ...
                      <span>{menuAberto === "biblioteca" ? "▾" : "▸"}</span>
                    </button>
                    ...
                    <div className="ml-3 mt-2 flex flex-col space-y-1">
                      ...
                      {temPermissao("financeiro.ver") && (
                        <Link
                          ...
                          className={getLinkClass("/admin/financeiro/taxas")}
                        >
                          🧾 {tNav("oneOffFees")}
                        </Link>
                      )}
                      ...
                      {ehIbePolos && (
                        ...
                        >
                          🧾 {tNav("generateInvoiceForInterestedParty")}
                        </Link>
                      )}
                      ...
                      <div className="ml-3 mt-2 flex flex-col space-y-1">
                        ...
                        {podeVerProfessoresRH && (
                          <Link
                            ...
                            className={getLinkClass("/admin/rh/professores")}
                          >
                            👨‍🏫 {tNav("teachers")}
                          </Link>
                        )}
                        ...
                        {podeVerComissoesRH && (
                          <Link
                            ...
                            className={getLinkClass("/admin/rh/comissoes")}
                          >
                  ...
                  {menuAberto === "configuracoes" && (
                    <div className="ml-3 mt-2 flex flex-col space-y-1">
                      ...
                      <Link
                        ...
                        className={getLinkClass("/admin/configuracoes/logos")}
                      >
                      ...
                      {podeGerenciarEmailInstitucional && (
                        <Link
                          ...
                          className={getLinkClass("/admin/integracoes/email")}
                        >
                      ...
                      <Link
                        ...
                        className={getLinkClass(
                          "/admin/configuracoes/documentos",
                        )}
                      >
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-[70] border-t border-slate-200 bg-white/95 px-2 py-2 shadow-[0_-8px_25px_rgba(15,23,42,0.12)] backdrop-blur lg:hidden">
              <div
                className={[
                  ...
                  podeVerComercialInstituicao ? "grid-cols-8" : "grid-cols-7",
                ].join(" ")}
              >
                <Link
                  href="/admin"
                ...
                <button
                  ...
                  onClick={() =>
                    setMenuMobileAberto(
                      menuMobileAberto === "Acadêmico" ? null : "Acadêmico",
                    )
                  }
                  className="flex flex-col items-center justify-center rounded-xl px-1 py-2 hover:bg-blue-50 hover:text-blue-700"
                >
                ...
                {podeVerComercialInstituicao && (
                  <button
                    ...
                    onClick={() =>
                      setMenuMobileAberto(
                        menuMobileAberto === "Comercial" ? null : "Comercial",
                      )
                    }
                    className={[
                ...
                <button
                  ...
                  onClick={() =>
                    setMenuMobileAberto(
                      menuMobileAberto === "Financeiro" ? null : "Financeiro",
                    )
                  }
                  className="flex flex-col items-center justify-center rounded-xl px-1 py-2 hover:bg-blue-50 hover:text-blue-700"
                >
                ...
                <button
                  type="button"
                  onClick={() =>
                    setMenuMobileAberto(menuMobileAberto === "RH" ? null : "RH")
                  }
                  className="flex flex-col items-center justify-center rounded-xl px-1 py-2 hover:bg-blue-50 hover:text-blue-700"
                >
                  <span className="text-lg">👥</span>
                ...
                <button
                  ...
                  onClick={() =>
                    setMenuMobileAberto(
                      menuMobileAberto === "Documentos" ? null : "Documentos",
                    )
                  }
                  className="flex flex-col items-center justify-center rounded-xl px-1 py-2 hover:bg-blue-50 hover:text-blue-700"
                >
