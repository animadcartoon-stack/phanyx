      ...
      <section className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 p-6 dark:border-slate-700">
          ...
          <button
            ...
            className="rounded-xl border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-800 transition hover:bg-slate-100 disabled:opacity-60 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:hover:bg-slate-800"
          >
            Recarregar
          </button>
        </div>
                    ...
                    <div className="space-y-4 p-5">
                      <div>
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          {logo.principal && (
                            <span className="rounded-full border border-blue-300 bg-blue-50 px-2 py-1 text-[10px] font-bold uppercase text-blue-800 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-200">
                              Principal
                            </span>
                          )}
                        </div>
                        ...
                        <div className="mt-2 flex flex-wrap gap-2">
                          <span
                            className={`rounded-full border px-2 py-1 text-[10px] font-bold uppercase ${classeTipo(
                              logo.tipo
                            )}`}
                          >
                            {nomeTipo(
                      ...
                      <div className="grid gap-2 sm:grid-cols-2">
                        {!logo.principal && (
                          <button
                            ...
                            className="rounded-xl border border-blue-300 bg-blue-50 px-3 py-2 text-xs font-semibold text-blue-800 transition hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-50 dark:border-blue-800 dark:bg-blue-950/40 dark:text-blue-200"
                          >
                            Definir principal
                          </button>
                        )}
                        ...
                        <button
                          ...
                          className="rounded-xl border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-800 transition hover:bg-slate-100 disabled:opacity-50 dark:border-slate-700 dark:bg-slate-950 dark:text-white dark:hover:bg-slate-800"
                        >
                          {logo.ativa
                            ? "Desativar"
                            : "Ativar"}
                        ...
                        <button
                          ...
                          className="rounded-xl border border-violet-300 bg-violet-50 px-3 py-2 text-xs font-semibold text-violet-800 transition hover:bg-violet-100 disabled:opacity-50 dark:border-violet-800 dark:bg-violet-950/40 dark:text-violet-200"
                        >
                          Alterar finalidade
                        </button>
                        ...
                        <button
                          ...
                          className="rounded-xl border border-red-300 bg-red-50 px-3 py-2 text-xs font-semibold text-red-800 transition hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50 dark:border-red-900 dark:bg-red-950/30 dark:text-red-200"
                        >
                          Excluir
                        </button>
                      </div>
