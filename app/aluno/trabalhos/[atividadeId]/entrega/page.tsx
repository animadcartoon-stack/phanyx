...
import EntregaTrabalhoAlunoClient from "./EntregaTrabalhoAlunoClient";

export default async function EntregaTrabalhoAlunoPage({
  params,
}: {
  ...
  if (!token) redirect("/login?portal=aluno");
  ...
  return <EntregaTrabalhoAlunoClient atividadeId={atividadeId} />;
}