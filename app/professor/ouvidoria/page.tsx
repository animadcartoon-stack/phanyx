    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-slate-600">
          ...
          ou relatar situações que possam contribuir para a melhoria da
          instituição.
        </p>
      </div>
  ...
  {enviando ? "Enviando..." : "Enviar manifestação"}
      ...
      <div className="rounded-3xl border border-blue-100 bg-blue-50 p-5">
        ...
        <ul className="mt-3 space-y-2 text-sm text-slate-700">
          <li>• Sua manifestação será encaminhada à administração.</li>
          <li>• O acompanhamento ficará disponível futuramente nesta área.</li>
          <li>• Sugestões ajudam na evolução contínua da instituição.</li>
          <li>• Reclamações e relatos serão analisados com prioridade adequada.</li>
        </ul>
      </div>
    </div>
  );
